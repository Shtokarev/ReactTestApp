...
export type AuthErrorAction = BaseActionType<"AUTH_ERROR", AuthErrorPayload>;
...
export const resetAuth = generateSimpleActionCreator<"AUTH_RESET">(
  "AUTH_RESET"
);
...
export type AuthSetAction = BaseActionType<"AUTH_SET", AuthSetPayload>;
export const setAuth = generateActionCreator<"AUTH_SET", AuthSetPayload>(
  "AUTH_SET"
);

// AuthLogoutAction
export type AuthLogoutAction = BaseActionType<"AUTH_LOGOUT">;
export const logoutAuth = generateSimpleActionCreator<"AUTH_LOGOUT">(
  "AUTH_LOGOUT"
);
